...
public class GroceryReporterTest {
    //make tests for the GroceryReporter class
    @Test
    public void testGetOriginalFileText() {
        //given
        ...
        //when
        String actual = groceryReporter.getOriginalFileText();
        //then
        Assert.assertEquals(expected, actual);
    }
    @Test
    public void testGetCleanReportText() {
        //given
        String expected =
        ...
        GroceryReporter groceryReporter = new GroceryReporter("RawInput.txt");
        //when
        String actual = groceryReporter.getCleanReportText();
        //then
        Assert.assertEquals(expected, actual);
    }
}
